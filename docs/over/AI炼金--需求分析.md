...
| 4 | 答题闯关 + 即时讲解 | **已实现** | 3 点「灵韵」值；答错扣除1点；服务端判题并返回讲解 |
...
| 数据安全 | AI API Key 仅存后端 `.env`，不暴露给小程序 |
...
| 文档 | 说明 |
|------|------|
| [AI--方案设计.md](./AI--方案设计.md) | 技术架构与实现方案 |
