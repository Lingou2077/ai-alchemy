...
| `COS_BUCKET` | COS 桶名 | 如 `yunpic-1348558641` |
...
COS_BUCKET=yunpic-1348558641
COS_AVATAR_PREFIX=aialchemy/avatars
COS_PUBLIC_BASE_URL=https://yunpic-1348558641.cos.ap-guangzhou.myqcloud.com
```

微信公众平台 → 开发设置 → **downloadFile 合法域名** 需添加：

```
yunpic-1348558641.cos.ap-guangzhou.myqcloud.com
```
...
```ts
API_BASE_URL: '"http://192.168.1.100:8000"'  // 替换为你的 IP
```
