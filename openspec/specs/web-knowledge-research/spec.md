...
Integrate Tavily web search and extraction via a bounded LangChain Research Agent to gather grounding materials before topic disambiguation and quiz generation.
